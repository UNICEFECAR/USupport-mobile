...
import { AppText, Notification, AppButton, Line } from "#components";
...
/**
 * Shared notifications list logic (infinite query, provider names, render item).
 *
 * @param {object} params
 * @param {string} [params.notificationType] server filter: all | new | read
 * @param {() => void} [params.onAfterNavigate] called after navigating from a notification tap (e.g. close dropdown)
 */
